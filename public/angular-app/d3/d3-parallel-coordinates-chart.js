    ...
    return {
        ...
        link: function(scope, ele) {
            ...
            scope.render = function (data) {
                ...
                var margin = {top: 50, right: 110, bottom: 20, left: 200},
                ...
                // canvasTest.width = width * devicePixelRatio;
                // canvasTest.height = height * devicePixelRatio;
                // canvasTest.style.width = width + "px";
                // canvasTest.style.height = height + "px";
                // canvasTest.style.marginTop = margin.top + "px";
                // canvasTest.style.marginLeft = margin.left + "px";
                // canvasTest.style.pointerEvents = "none";
                //
